...
docker build -t metorikku/metorikku:spark2_k8s --build-arg IMAGE_NAME=metorikku/spark:spark2_hadoop --build-arg SCALA_MAJOR_VERSION=${SPARK2_SCALA_MAJOR_VERSION} -f docker/metorikku/Dockerfile .
