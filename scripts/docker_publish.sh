...
docker tag metorikku/metorikku:spark2_k8s metorikku/metorikku:k8s_"$TRAVIS_TAG"_spark_"$SPARK2_VERSION"
docker tag metorikku/hive metorikku/hive:$HIVE_VERSION

docker push metorikku/metorikku:standalone
docker push metorikku/metorikku:standalone_"$TRAVIS_TAG"_spark_"$SPARK_VERSION"
...
docker push metorikku/metorikku:k8s_"$TRAVIS_TAG"_spark_"$SPARK2_VERSION"
docker push metorikku/hive
docker push metorikku/hive:$HIVE_VERSION
