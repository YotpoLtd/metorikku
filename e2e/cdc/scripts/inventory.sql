...
VALUES (default,"Sally","Thomas","sally.thomas@acme.com",UNIX_TIMESTAMP(NOW())),
       (default,"George","Bailey","gbailey@foobar.com",UNIX_TIMESTAMP(NOW())),
       (default,"Edward","Walker","ed@walker.com",UNIX_TIMESTAMP(NOW())),
       (default,"Anne","Kretchmar","annek@noanswer.org",UNIX_TIMESTAMP(NOW()));
