...
### The Data
We have our movies data in the file system as a bunch of files saved in a date-range manner.
Imagine every movie that was reviewed in every single day. So our input is spread to YYYY/MM/DD format directories.
```
+-------+-------------------------------------------------------------------------------+-------------------------------------------+
...
inputs:
 movies:
   ...
   template: examples/inputs/%s/movies.csv
   dateRange:
     format: yyyy/MM/dd
